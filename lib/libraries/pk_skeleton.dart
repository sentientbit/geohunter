...
///
Decoration myBoxDec(dynamic animation, {bool isCircle = false}) {
...
///
Decoration myDarkBoxDec(dynamic animation, {bool isCircle = false}) {
  return BoxDecoration(
    shape: isCircle ? BoxShape.circle : BoxShape.rectangle,
    gradient: LinearGradient(
      begin: Alignment.centerLeft,
...
///
class PKUserProfileSkeleton extends StatefulWidget {
  ///
  final bool isCircularImage;
  ...
  ///
  PKUserProfileSkeleton(
      {this.isCircularImage = true, this.isBottomLinesActive = true});
  @override
  _PKUserProfileSkeletonState createState() => _PKUserProfileSkeletonState();
}
